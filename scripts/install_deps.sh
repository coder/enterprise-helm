...
run_trace false curl "${curl_flags[@]}" "https://get.helm.sh/helm-v3.5.4-linux-amd64.tar.gz" \| \
...
run_trace false curl "${curl_flags[@]}" "https://github.com/stackrox/kube-linter/releases/download/0.1.6/kube-linter-linux.tar.gz" \| \
