...
| coderd.liveness | object | Configure the liveness check for the coderd service. | `{"failureThreshold":15,"initialDelaySeconds":10,"periodSeconds":10,"timeoutSeconds":3}` |
