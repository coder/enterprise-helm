...
| services.nodeSelector | object | Node selectors that will be applied to all Coder managed services. | `{"beta.kubernetes.io/arch":"amd64","beta.kubernetes.io/os":"linux"}` |
